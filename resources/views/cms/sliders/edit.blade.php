<x-app-layout title="Edit Slider" is-header-blur="true">
                ...
                <form action="{{ route('cms.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block">
                            ...
                            <input type="color" name="background_color" value="{{ old('background_color', $slider->background_color ?: '#000000') }}"
                        ...
                        <label class="block">
                            ...
                            <input type="color" name="text_color" value="{{ old('text_color', $slider->text_color ?: '#ffffff') }}"
                                class="form-input mt-1.5 h-12 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent">
                            @error('text_color')
                                <span class="text-tiny-plus text-error">{{ $message }}</span>
                            @enderror
                        ...
                        <label class="block sm:col-span-2">
                            ...
                            <input type="range" name="overlay_opacity" value="{{ old('overlay_opacity', $slider->overlay_opacity) }}" min="0" max="1" step="0.1"
                                class="form-range mt-1.5 w-full">
                            <div class="mt-1 text-xs text-slate-500 dark:text-navy-300">
                                <span id="opacity-value">{{ old('overlay_opacity', $slider->overlay_opacity) }}</span>
                            </div>
                        ...
                        <label class="block sm:col-span-2">
                            ...
                            <div class="mt-1.5">
                                ...
                                <p class="mt-1 text-xs text-slate-500 dark:text-navy-300">
                                    Recommended size: 1920x1080px. Max file size: 5MB. Leave empty to keep current image.
                                </p>
                            </div>
                            @error('image')
                                <span class="text-tiny-plus text-error">{{ $message }}</span>
