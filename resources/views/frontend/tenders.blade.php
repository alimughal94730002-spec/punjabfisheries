  ...
  <section class="pt-32 pb-20 bg-primary-50">
    <div class="cont">
      <div class="text-center">
        <h1 class="text-4xl xl:text-5xl font-bold text-neutral-900 mb-4">{{ __('app.tenders') }}</h1>
        <p class="text-lg text-neutral-600 max-w-2xl mx-auto">{{ __('app.latest_tender_notices') }}</p>
      </div>
    </div>
  </section>
